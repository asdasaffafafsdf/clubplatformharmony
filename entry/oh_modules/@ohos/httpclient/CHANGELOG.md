...
## 2.0.6-rc.3
1. Fixed the issue where the domain name did not go through custom DNS resolution after redirection.

## 2.0.6-rc.2
1. Fixed the issue where asynchronous queue objects are not deleted after the repair request ends.

## 2.0.6-rc.1
1. Fixed the issue where Delete/Post/Put could not correctly request urls carrying Chinese Params

## 2.0.6-rc.0
1. Fixed the issue where delete requests could not carry the body
2. Fixed the issue where put requests were actually post requests
3. Fixed the issue where the Host in the Header field of post/put requests was constructed incorrectly
4. Fixed the issue where Post/Put could not correctly request urls carrying Params
...
## 2.0.5-rc.2
1. Skipping certificate verification is supported
2. Fix occasional encoding issues with Chinese characters in response
3. Fix the issue of some error logs being missing

## 2.0.5-rc.1
1. Fix Failed to post/put binary content after setting certificate or certificate Pinner
2. Change the default boundary value of the multipart type to a random value
