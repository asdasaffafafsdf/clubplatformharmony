...
var _skipRemoteValidation = Symbol();
...
class Request {
    constructor(build) {
        ...
        this[_skipRemoteValidation] = build[_skipRemoteValidation];
    }
        ...
        class Builder {
            constructor(request?: Request) {
                if (!!request) {
                    ...
                    this[_skipRemoteValidation] = request.skipRemoteValidation;
                    return
                }
                this[_method] = '';
                this[_ca] = [];
                ...
                this[_skipRemoteValidation] = false
            }
            ...
            skipRemoteValidation(value:boolean) {
                this[_skipRemoteValidation] = value;
                return this;
            }
    ...
    get skipRemoteValidation() {
        return this[_skipRemoteValidation]
    }
